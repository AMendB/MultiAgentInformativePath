...
# Read the data
folder = 'Experiments/Results/REV1/'
paths = [
        #  f'{folder}/[0.007 0.02 0.056 0.091] Random Network.4.Influence_10_0_100/metrics.csv', 
        ...
        #  f'{folder}/[0.007 0.02 0.213 0.13] Random PSO.4.Influence_10_0_100/metrics.csv'
         f'{folder}/[0.008 0.17 0.03 0.095] Random Network.4.Influence_10_0_100/metrics.csv', 
         f'{folder}/[0.008 0.17 0.03 0.095] Random WanderingAgent.4.Influence_10_0_100/metrics.csv', 
         f'{folder}/[0.008 0.17 0.03 0.095] Random LawnMower.4.Influence_10_0_100/metrics.csv', 
         f'{folder}/[0.008 0.17 0.03 0.095] Random PSO.4.Influence_10_0_100/metrics.csv', 
         ]
...
#Eliminar outliers
# Q1 = data['Value'].quantile(0.1)
# Q3 = data['Value'].quantile(0.9)
# IQR = Q3 - Q1
